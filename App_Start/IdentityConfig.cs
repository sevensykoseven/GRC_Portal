...
namespace protean
{
    public class EmailService : IIdentityMessageService
    {
        ...
        {
            // Send email
            SmtpClient client = new SmtpClient(EnvironmentSettings.AppSettings("SMTPServer"));
            //return client.SendMailAsync(EnvironmentSettings.AppSettings("AutomatedEmailEmail"),
            //                            message.Destination,
            //                            message.Subject,
            //                            message.Body);
    ...
    public class ApplicationSignInManager : SignInManager<ApplicationUser, string>
    {
        ...
        /// <summary>
        /// Override password sign in function to include check for enabled or not.
        /// </summary>

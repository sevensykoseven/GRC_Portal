...
namespace protean.Areas.RepGroupPortal.Controllers
{
    ...
    [SelectedSidebar("openquotegroupreport")]
    public class RepGroupQuotesController : Controller
    {
        /// <summary>
        /// Get Open quotes for this rep group
        /// </summary>
        ...
        public ActionResult OpenQuotes()
        {
            ...
            newObj = EAL.Quotes.GetRepGroupOpenQuotes(Current.User.SalesRep.RepGroupId);
            openQuoteCount = Convert.ToInt32(newObj.value.Count);
            if (newObj.value.Count > 0)
            {
                foreach (var item in newObj.value)
                {
                    openQuoteTotal += Convert.ToDecimal(item.GRC_OpenQuotesActiveReps_QuoteTotal);
                }
            }
        ...
        /// <summary>
        /// Get open quotes for rep group in excel
        /// </summary>
        ...
        public FileStreamResult GetOpenQuotes_Excel()
        {
            ...
            dynamic newObj = EAL.Quotes.GetRepGroupOpenQuotes(Current.User.SalesRep.RepGroupId);
        ...
        /// <summary>
        /// Get Open quote details for quotenum
        /// </summary>
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult SendRepGroupQuotePrint(string id)
        {
            // Decrypt id
            id = Cryptography.DecodeAndDecrypt(id, GlobalVariables.InternalKey);

            var result = EAL.RPT.SendQuotePrintBySalesRepGroup(Convert.ToInt32(id), Current.User.Email, Current.User.SalesRep.RepGroupId);
